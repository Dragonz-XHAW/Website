// Course data - Only Six-month courses
const allCourses = [
    // Six-month Courses
    {
        id: 1,
...
function renderCourses() {
    ...
    document.getElementById('results-count').textContent = 
        `Showing all ${filteredCourses.length} six-month courses`;
}
...
function applyFilters() {
    ...
    const categoryCheckboxes = document.querySelectorAll('input[id="first-aid"], input[id="sewing"], input[id="landscaping"], input[id="life-skills"]');
